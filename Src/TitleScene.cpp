...
bool TitleScene::Initialize() {
	...
	texLogo.Reset(Texture::LoadImage2D("Res/Image/TitleLogo.tga"));
	texBackGround.Reset(Texture::LoadImage2D("Res/Image/TitleBack.tga"));
...
void TitleScene::Render() {
	...
	progSimple.Draw(meshList.Get(5), glm::vec3(400, 300, -1), glm::vec3(0), glm::vec3(400, 300, 1));
	progSimple.BindTexture(0, texLogo.Get());
	progSimple.Draw(meshList.Get(5), glm::vec3(400, 300, 0), glm::vec3(0), glm::vec3(400, 300, 1));
}
